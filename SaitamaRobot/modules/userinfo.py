...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Disaster level of this person is 'Mythic'."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis user is member of 'Legend'."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThe Disaster level of this person is 'Epic'."
        disaster_level_present = True
        ...
        text += "\n\nThe Disaster level of this person is 'Elite'."
        disaster_level_present = True

    if disaster_level_present:
        text += ' [<a href="https://t.me/AnimeChat74/1956">?</a>]'.format(
            bot.username)
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Erm... yeah, I only trust Legend to set my bio.")
            return
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/AnimeChat74/2110)
"""
