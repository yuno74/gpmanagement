...
The Support group can be reached out to at [One Kick Support](https://t.me/OneKickSupport), where you can ask for help about [SaitamaRobot](https://t.me/SaitamaRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [One Kick Updates](https://t.me/OneKickUpdates) 

## How to setup/deploy.

### Read these notes carefully before proceeding 
 - Edit any mentions of @OneKickSupport to your own support chat. 
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/yuno74/kiritoPV.git)
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [One Kick Support](https://t.me/OneKickSupport)
...
Should any be missing kindly let us know at [One Kick Support](https://t.me/OneKickSupport) or simply submit a pull request on the readme.
